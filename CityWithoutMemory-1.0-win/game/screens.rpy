...
screen navigation():
    ...
    hbox:
       ...
       # textbutton _("Options") action ShowMenu("preferences")
        ...
        textbutton _("Опрограмме") action ShowMenu("about")
...
screen main_menu():
    ...
    vbox:
       ...
       # textbutton _("Помощь") action ShowMenu("help") at button4
        textbutton _("О программе") action ShowMenu("about") at button5
        textbutton _("Выход") action Quit(confirm=not main_menu) at button6

    add "gui/overlay/main_menu_logo.png"

    text "[config.name!t]" size 60 xpos 301 ypos 225 xanchor 0.5 yanchor 0.5 color u"#766249"
        ...
        viewport id "vpgrid":
            ...
            vbox:
                ...
                if not _history_list:
                    label _("История пуста") xalign 0.5
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton _("В главное меню") action MainMenu(confirm=False)
                textbutton _("Отмена          ") action Null
